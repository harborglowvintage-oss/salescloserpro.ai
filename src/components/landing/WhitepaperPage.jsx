          ...
          <section className="mb-16">
            ...
            <div className="space-y-5">
              {[
                ...
                { num: 4, title: 'The Construction Cash Flow Crisis', desc: '97% of contractors experience stress over slow payments and cash flow problems. 46% of subcontractors struggle with cash flow, and 63% pay for materials before receiving payment.', source: 'Levelset / Procore', url: 'https://www.levelset.com/blog/construction-cash-flow-problems/' },
                { num: 5, title: 'The Purchasing Power Squeeze', desc: 'The U.S. dollar has experienced a continuous decline in real purchasing power, penalizing operators who hold capital in depreciating fiat over long payment cycles.', source: 'MacroMicro', url: 'https://en.macromicro.me' },
                { num: 6, title: 'The $250,000 Invoice Fraud Problem', desc: 'Construction fraud is surging with a median loss of $250,000 per incident — 72% above the global average. Invoice manipulation and interception are the leading threats destroying margins.', source: 'Veryfi', url: 'https://www.veryfi.com/fraud-detection/construction-fraud-the-250000-problem-threatening-your-business/' },
                { num: 7, title: 'The Stablecoin Settlement Advantage', desc: 'Stablecoin transaction volume grew 30% month-over-month in 2025, reaching $5.7 trillion. Businesses adding stablecoins attract 2× more new customers than traditional payment methods.', source: 'Stripe', url: 'https://stripe.com/guides/why-your-business-needs-a-stablecoin-strategy' },
                { num: 8, title: 'The Sovereign Cash Flow Loop', desc: 'Diverting material and operational spending through crypto-rewards infrastructure allows operators to earn up to 4% back in appreciating digital assets on everyday business expenses.', source: 'Gemini', url: 'https://www.gemini.com/credit-card' },
                { num: 9, title: 'Oil Jumps 10% on Iran Conflict', desc: 'Oil prices spiked 10% as U.S.-Iran conflict escalated, with analysts warning of $100/barrel. Major oil companies and traders suspended shipments via the Strait of Hormuz.', source: 'Reuters', url: 'https://www.reuters.com/business/energy/oil-jumps-10-iran-conflict-could-spike-100-barrel-analysts-say-2026-03-01/' },
                { num: 10, title: 'Investors Brace for Middle East War Backlash', desc: 'Middle East conflict has become a top worry for investors, with ramifications for global trade, inflation, and supply chains — directly threatening construction material costs.', source: 'Reuters', url: 'https://www.reuters.com/world/middle-east/investors-brace-bigger-backlash-middle-east-war-2026-03-01/' },
