          ...
          <div className="max-w-6xl mx-auto rounded-2xl bg-slate-950 border border-white/[0.08] p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="rounded-xl border border-white/[0.08] border-t-2 border-t-cyan-500 bg-white/[0.03] p-3">
                ...
                <div className="grid grid-cols-3 gap-1.5">
                  <a href="https://www.awin1.com/cread.php?awinmid=83699&awinaffid=2848879&ued=https%3A%2F%2Fburtongoods.com%2Fproducts%2Fslim-leather-laptop-briefcase-medium-16" target="_blank" rel="sponsored nofollow noopener" title="Burton Goods" className="w-full h-[44px] bg-white rounded-md flex items-center justify-center px-2 hover:opacity-90 transition-all duration-200 ring-1 ring-blue-400/70 shadow-[0_0_14px_rgba(59,130,246,0.55)] hover:shadow-[0_0_24px_rgba(59,130,246,0.90)]"><img src="/logos/burton-goods-83699.webp" alt="Burton Goods" className="max-h-6 w-auto" /></a>
              ...
              <div className="rounded-xl border border-white/[0.08] border-t-2 border-t-blue-500 bg-white/[0.03] p-3">
                ...
                <div className="grid grid-cols-3 gap-1.5">
                  <a href="https://www.awin1.com/cread.php?awinmid=125364&awinaffid=2848879&ued=https%3A%2F%2Fairbrush.com%2Fpricing" target="_blank" rel="sponsored nofollow noopener" title="Airbrush" className="w-full h-[44px] bg-white rounded-md flex items-center justify-center px-2 hover:opacity-90 transition-all duration-200 ring-1 ring-blue-400/70 shadow-[0_0_14px_rgba(59,130,246,0.55)] hover:shadow-[0_0_24px_rgba(59,130,246,0.90)]"><img src="/logos/airbrush-125364.webp" alt="Airbrush" className="max-h-6 w-auto" /></a>
